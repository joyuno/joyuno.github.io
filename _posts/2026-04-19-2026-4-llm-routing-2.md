...
description: "(1) 모든 요청을 비싼 모델로 보냄: “품질 안전”은 얻지만, 트래픽이 늘면 비용이 선형 폭증 (2) 컨텍스트가 무한히 비대해짐: system prompt/툴 스키마/RAG 문서/대화 히스토리가 매 요청마다 반복 전송 (3) 라우팅을 LLM에게 맡김: “어느 모델 쓸지 판단해줘”…"
---
## 들어가며
